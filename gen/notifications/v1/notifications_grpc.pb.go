...
const (
	NotificationService_SendEmail_FullMethodName           = "/notifications.v1.NotificationService/SendEmail"
	NotificationService_PublishNotification_FullMethodName = "/notifications.v1.NotificationService/PublishNotification"
)
...
//
// NotificationService envía correos con plantillas y publica notificaciones
...
func (c *notificationServiceClient) PublishNotification(ctx context.Context, in *PublishNotificationRequest, opts ...grpc.CallOption) (*PublishNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_PublishNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotificationServiceServer) PublishNotification(context.Context, *PublishNotificationRequest) (*PublishNotificationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PublishNotification not implemented")
}
